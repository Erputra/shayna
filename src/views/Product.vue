                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="product-pic-zoom">
                                <img class="product-big-img" :src="mpp" alt="" />
                            </div>
                            <div class="product-thumbs">
                                <carousel class="product-thumbs-track ps-slider" :nav="false" :dots="false">
                                    
                                    <div class="pt " @click="ChangeImage(spp[0])" :class="spp[0] == mpp ? 'active' : ''">
                                        <img :src="spp[0]" alt="" />
                                    </div>
                                    
                                    <div class="pt " @click="ChangeImage(spp[1])" :class="spp[1] == mpp ? 'active' : ''">
                                        <img :src="spp[1]" alt="" />
                                    </div>
                                                                        
                                    <div class="pt " @click="ChangeImage(spp[2])" :class="spp[2] == mpp ? 'active' : ''">
                                        <img :src="spp[2]" alt="" />
                                    </div>
                                                                        
                                    <div class="pt " @click="ChangeImage(spp[3])" :class="spp[3] == mpp ? 'active' : ''">
                                        <img :src="spp[3]" alt="" />
                                    </div>
                                </carousel>
                            </div>
